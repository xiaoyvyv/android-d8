  ...
  private Set<DexType> filterMissingClasses(Set<DexType> missingClasses,
    ...
    for (ProguardTypeMatcher matcher : dontWarnPatterns) {
      if (matcher instanceof MatchSpecificType) {
        ...
        result.removeIf(new Predicate<DexType>() {
          @Override
    ...
    try {
      ...
      try {
        ...
        if (!missingClasses.isEmpty()) {
          ...
          missingClasses.forEach(new Consumer<DexType>() {
            @Override
            public void accept(DexType clazz) {
      ...
      if (options.hasMethodsFilter()) {
        ...
        options.methodsFilter.forEach(new Consumer<String>() {
          @Override
