...
public class ProgramClassCollection extends ClassMap<DexProgramClass> {
  public static ProgramClassCollection create(List<DexProgramClass> classes) {
    ...
    for (DexProgramClass clazz : classes) {
      map.merge(clazz.type, clazz, new BiFunction<Supplier<DexProgramClass>, Supplier<DexProgramClass>, Supplier<DexProgramClass>>() {
        @Override
        public Supplier<DexProgramClass> apply(Supplier<DexProgramClass> a, Supplier<DexProgramClass> b) {
          return resolveClassConflictImpl(a.get(), b.get());
        }
      });
    }
