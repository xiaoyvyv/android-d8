...
public class DexAnnotationSet extends CachedHashValueDexItem {
  ...
  public void sort() {
    ...
    Arrays.sort(annotations, new Comparator<DexAnnotation>() {
      @Override
      public int compare(DexAnnotation a, DexAnnotation b) {
        return a.annotation.type.compareTo(b.annotation.type);
      }
    });
