...
public class ObjectToOffsetMapping {
  ...
  private static DexProgramClass[] sortClasses(
    ...
    Arrays.sort(classes, new Comparator<DexProgramClass>() {
      @Override
      public int compare(DexProgramClass o1, DexProgramClass o2) {
        return o1.type.descriptor.slowCompareTo(o2.type.descriptor);
      }
    });
