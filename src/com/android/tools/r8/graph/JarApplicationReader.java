...
public class JarApplicationReader {
  ...
  public DexString getString(String string) {
    return stringCache.computeIfAbsent(string, new Function<String, DexString>() {
      @Override
      public DexString apply(String source) {
        return options.itemFactory.createString(source);
      }
    });
  }
