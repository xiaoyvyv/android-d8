...
public class DexFileReader {
  ...
  private DexTypeList typeListAt(int offset) {
    ...
    return (DexTypeList) cacheAt(offset, new Supplier<Object>() {
      @Override
      public Object get() {
        return DexFileReader.this.parseTypeList();
      }
    });
  }
  ...
  private DexEncodedArray encodedArrayAt(int offset) {
    return (DexEncodedArray) cacheAt(offset, new Supplier<Object>() {
      @Override
      public Object get() {
        return DexFileReader.this.parseEncodedArray();
      }
    });
  }
  ...
  private DexAnnotationSetRefList annotationSetRefListAt(int offset) {
    return (DexAnnotationSetRefList) cacheAt(offset, new Supplier<Object>() {
      @Override
      public Object get() {
        return DexFileReader.this.parseAnnotationSetRefList();
      }
    });
  }
  ...
  private DexAnnotation annotationAt(int offset) {
    return (DexAnnotation) cacheAt(offset, new Supplier<Object>() {
      @Override
      public Object get() {
        return DexFileReader.this.parseAnnotation();
      }
    });
  }
  ...
  private DexAnnotationSet annotationSetAt(int offset) {
    return (DexAnnotationSet) cacheAt(offset, new Supplier<Object>() {
      @Override
      public Object get() {
        return DexFileReader.this.parseAnnotationSet();
      }
    }, new Supplier<Object>() {
      @Override
      public Object get() {
  ...
  private AnnotationsDirectory annotationsDirectoryAt(int offset) {
    return (AnnotationsDirectory) cacheAt(offset, new Supplier<Object>() {
              @Override
              public Object get() {
                return DexFileReader.this.parseAnnotationsDirectory();
              }
            },
            new Supplier<Object>() {
              @Override
  ...
  private DexDebugInfo debugInfoAt(int offset) {
    return (DexDebugInfo) cacheAt(offset, new Supplier<Object>() {
      @Override
      public Object get() {
        return DexFileReader.this.parseDebugInfo();
      }
    });
  }
  ...
  private DexEncodedField[] readFields(int size, DexFieldAnnotation[] annotations,
    ...
    MemberAnnotationIterator<DexField, DexAnnotationSet> annotationIterator =
        new MemberAnnotationIterator<>(annotations, new Supplier<DexAnnotationSet>() {
          @Override
          public DexAnnotationSet get() {
            return DexAnnotationSet.empty();
          }
        });
    for (int i = 0; i < size; i++) {
  ...
  private DexEncodedMethod[] readMethods(int size, DexMethodAnnotation[] annotations,
    ...
    MemberAnnotationIterator<DexMethod, DexAnnotationSetRefList> parameterAnnotationsIterator =
        new MemberAnnotationIterator<>(parameters, new Supplier<DexAnnotationSetRefList>() {
          @Override
          public DexAnnotationSetRefList get() {
