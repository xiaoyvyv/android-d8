...
public class BasicBlock {
  ...
  public void clearUserInfo() {
    ...
    instructions.forEach(new Consumer<Instruction>() {
      ...
      public void accept(Instruction instruction) {
        Instruction.clearUserInfo(instruction);
      }
    });
  }
  ...
  private static boolean blocksClean(List<BasicBlock> blocks) {
    blocks.forEach(new Consumer<BasicBlock>() {
      @Override
  ...
  public String toDetailedString() {
    ...
    appendBasicBlockList(builder, predecessors, new Function<BasicBlock, String>() {
      @Override
      public String apply(BasicBlock b) {
        return "";
      }
    });
    builder.append('\n');
    builder.append("successors: ");
    appendBasicBlockList(builder, successors, new Function<BasicBlock, String>() {
      @Override
      public String apply(BasicBlock block) {
        return BasicBlock.this.predecessorPostfix(block);
      }
    });
  ...
  public CatchHandlers<BasicBlock> getCatchHandlers() {
    ...
    List<BasicBlock> targets = ListUtils.map(catchHandlers.getAllTargets(), new Function<Integer, BasicBlock>() {
      @Override
      public BasicBlock apply(Integer i) {
    ...
    for (BasicBlock catchSuccessor : catchSuccessors) {
      catchSuccessor.splitCriticalExceptionEdges(
          code.valueNumberGenerator,
              new Consumer<BasicBlock>() {
                @Override
                public void accept(BasicBlock newBlock) {
