...
public class BasicBlockInstructionIterator implements InstructionIterator, InstructionListIterator {
  ...
  protected BasicBlockInstructionIterator(BasicBlock block, Instruction instruction) {
    this(block);
    nextUntil(new Predicate<Instruction>() {
      @Override
      public boolean test(Instruction x) {
  ...
  @Override
  public Instruction nextUntil(Predicate<Instruction> predicate) {
    while (hasNext()) {
      Instruction item = next();
  ...
  @Override
  public BasicBlock split(IRCode code) {
  ...
  @Override
  public BasicBlock split(int instructions, IRCode code) {
  ...
  private void splitBlockAndCopyCatchHandlers(IRCode code, BasicBlock invokeBlock,
    ...
    while (currentBlock != null && instructionsIterator.hasNext()) {
      ...
      Instruction throwingInstruction =
          instructionsIterator.nextUntil(new Predicate<Instruction>() {
            @Override
  ...
  public BasicBlock inlineInvoke(
    ...
    if (inlinee.getNormalExitBlock() == null) {
      ...
      inlineeIterator.nextUntil(new Predicate<Instruction>() {
        @Override
        public boolean test(Instruction instruction) {
  ...
  @Override
  public BasicBlock inlineInvoke(IRCode code, IRCode inlinee) {
